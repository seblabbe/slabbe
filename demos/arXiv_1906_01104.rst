...
Running ``sage -t`` on this file takes 9.8 seconds with sage-9.1 and
slabbe-0.6.1.
...
::
    ...
    sage: P2 = P1
    sage: R2e1 = R1e1
    sage: R2e2 = PET.toral_translation(Gamma2, vector((0,phi^-2)))
...
::
    ...
    sage: R5e1_scaled = R3e1
    sage: R5e2_scaled = R3e2
...
::
    ...
    sage: R7e1_scaled = R3e1
    sage: R7e2_scaled = R3e2
...
::
    ...
    sage: R9e1_scaled = R3e1
    sage: R9e2_scaled = R3e2
